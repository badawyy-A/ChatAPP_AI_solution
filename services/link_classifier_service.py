...
def classify_url_service(url):
    ...
    m2_label = llama.get_report(f"I will send you a link. Respond with only one word: safe or unsafe. No explanation, no punctuation, no newline—just the word,  link : {url} ")
